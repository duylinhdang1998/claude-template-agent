...
- For traditional backlinks + content audit, fall back to `ahrefs-backlinks-analyst` / `google-seo-content-strategist`.
- For platform-specific deep-dives (ChatGPT only, Perplexity only), prefer the dedicated `google-seo-geo-strategist` skill which has Brand Mention Correlation guidance.
