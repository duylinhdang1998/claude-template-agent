...
- For Google AI Overviews citation rate, also cross-reference
  `dataforseo-data-analyst` AI visibility tools when available.

## Cross-skill delegation

- For end-to-end AI search audit (passage citability + brand mentions + platform-specific tuning), hand back to `google-seo-geo-strategist`.
- For prompt-set design + AI Cleanup pattern detection in cited content, fall back to `google-seo-content-strategist`.
