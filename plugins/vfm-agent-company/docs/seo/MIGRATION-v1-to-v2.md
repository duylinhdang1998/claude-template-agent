...
2. Three `Schema.org` rich-result types Google retired in 2025 are now
   marked as Critical findings when the `google-seo-schema-architect` skill detects them
...
### 2. `google-seo-schema-architect` flags retired rich-result types as Critical
