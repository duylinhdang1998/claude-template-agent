...
| `google-seo-content-strategist` | Quality check: E-E-A-T validation of generated content |
| `google-seo-schema-architect` | Schema markup: Article, BreadcrumbList, ItemList for cluster pages |
| `dataforseo-data-analyst` | Data source: SERP data when DataForSEO MCP is available |
| `google-search-console-analyst` | Reporting: generate PDF report of cluster plan and scorecard |
